import { CreateMessageOptions, Message, NullablePartialEmoji, PartialEmoji } from "oceanic.js";
...
export function edit(message: string, channel: string, opts: CreateMessageOptions | string): Promise<Message> {
    ...
    return MeowBot.rest.channels.editMessage(channel, message, opts);
}
...
export function send(channelID: string, opts: CreateMessageOptions | string): Promise<Message> {
    ...
    return MeowBot.rest.channels.createMessage(channelID, opts);
}

export async function deleteMsg(messageId: string, channelId: string) {
    return MeowBot.rest.channels.deleteMessage(channelId, messageId);
}
...
export const ZWSP = "\u200B";
export const EMPTY = "\u2800";
export function codeblock(s: string, lang = "") {
...
export function emoji(emoji: PartialEmoji) {
...
export function mostFrequentItem<T>(arr: T[]): [T, number] {
...
export function toWord(num: number) {
